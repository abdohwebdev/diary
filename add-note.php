...
<body>
    ...
    <div class="container main-content d-flex flex-column justify-content-center align-items-center">
        <form class="bg-light p-4 w-50" method="post" action="add-note.php">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="body" name="body" rows="9" placeholder="Write your diary note here .."><?php echo htmlspecialchars($_POST['body'] ?? ""); ?></textarea>
                <?php
